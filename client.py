...
SERVER_PORT = 5003
BUFFER_SIZE = 1440 # max size of messages, setting to 1440 after experimentaiton, MTU size
...
class Client:
    ...
    def handle_command(self, command):
        ...
        if command.lower() in ["exit", "quit"]:
            ...
            # if pyautogui is imported, take a screenshot and save it to a file
            ...
            # get the filename and send it if it exists
    ...
    def get_sys_hardware_info(cls):
        ...
        # get the IO statistics since boot
        ...
        output += tabulate(list_gpus, headers=("id", "name", "load", "free memory", "total memory", "temperature", "uuid"))
        return output
