...
class Server:
    ...
    def start_interpreter(self):
        ...
        while True:
            ...
            if re.search(r"help\w*", command):
                ...
                # do nothing if command is empty (i.e new line)
                pass
            else:
    ...
    def start_reverse_shell(self):
        ...
        while True:
            ...
            if command.lower() in ["exit", "quit"]:
                ...
                # if the command is abort, remove the client from the dicts and exit
                ...
                # send the specified file if it exist
                filename = match.group(1)
                if not os.path.isfile(filename):
                    print(f"The file {filename} does not exists in the local machine")
                else:
    ...
    def receive_all_data(self, socket, buffer_size):
        """Fucntion responsible for calling socket.recv()
